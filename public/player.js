        ...
        window.app = {
            clappr: {
                ...
                options: {
                    ...
                    strings: {
                        "tr-TR": {
                            back_to_live: "CanlÄ± yayÄ±na geri dÃ¶n",
                            live: "EN VIVO",
                            playback_not_supported: "TarayÄ±cÄ±nÄ±z bu ortamÄ± oynatamÄ±yor, lÃ¼tfen gÃ¼ncel bir tarayÄ±cÄ± ile deneyiniz."
                        },
                    },
                    width: '100%',
                    height: $(window).innerHeight()
            ...
            initAdv: function() {
                ...
                window.config.adv = window.app.extend({
                    link: "",
                    skipOffset: 5,
                    skipText: "ReklamÄ± geÃ§",
                    skipTextN: "ReklamÄ± geÃ§mek iÃ§in %d saniye kaldÄ±",
                }, window.config.adv);
